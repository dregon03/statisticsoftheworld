...
interface Props {
  ...
  initialTrending?: TrendingInsight[];
}

export default function DashboardContent({ initialQuotes, initialEvents, initialTrending }: Props) {
  const [quotes, setQuotes] = useState<Quote[]>(initialQuotes || []);
  const [events, setEvents] = useState<CalendarEvent[]>(initialEvents || []);
  const [trending, setTrending] = useState<TrendingInsight[]>(initialTrending || []);
