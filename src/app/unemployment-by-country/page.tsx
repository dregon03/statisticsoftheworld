...
export const metadata: Metadata = {
  title: 'Unemployment Rate by Country 2026 — Complete Global Rankings',
  description: 'Unemployment rate by country in 2026: all countries ranked from highest to lowest unemployment. Labor market data from IMF World Economic Outlook.',
