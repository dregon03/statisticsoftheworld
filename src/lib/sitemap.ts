...
export async function getSitemapUrls(id: number): Promise<MetadataRoute.Sitemap> {
  ...
  allUrls.push(
    ...
    { url: `${BASE_URL}/tariff-tracker`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    ...
    { url: `${BASE_URL}/data-sources`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/economic-calendar-guide`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
  );
