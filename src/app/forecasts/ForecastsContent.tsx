...
interface Props {
  initialIndicators: ForecastIndicator[];
  initialIndicator: ForecastIndicator | null;
  initialYears: number[];
  initialRows: ForecastRow[];
  initialSelectedId: string;
}

export default function ForecastsContent({
  initialIndicators,
  initialIndicator,
  initialYears,
  initialRows,
  ...
  const [indicators] = useState<ForecastIndicator[]>(initialIndicators);
  const [selectedId, setSelectedId] = useState(initialSelectedId);
  const [selectedIndicator, setSelectedIndicator] = useState<ForecastIndicator | null>(initialIndicator);
