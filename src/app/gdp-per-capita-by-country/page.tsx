...
export const metadata: Metadata = {
  ...
  description: 'GDP per capita by country in 2026: complete ranking of all countries by GDP per person in US dollars. From Luxembourg to Burundi. Source: IMF World Economic Outlook.',
