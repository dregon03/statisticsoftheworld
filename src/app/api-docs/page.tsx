      ...
      <div className="max-w-[900px] mx-auto px-4 py-10">
        ...
        <div className="border border-[#d5dce6] rounded-lg p-5 mb-8 bg-[#f4f6f9]">
          ...
          <div className="flex items-center justify-between mt-3 pt-2 border-t border-[#d5dce6]">
            <p className="text-[12px] text-[#64748b]">Rate limit headers: X-RateLimit-Limit, X-RateLimit-Remaining, X-RateLimit-Reset, X-RateLimit-Tier</p>
          ...
          {ENDPOINTS.map((ep, i) => (
            <div key={i} className="border border-[#d5dce6] rounded-lg overflow-hidden">
              <div className="flex items-center gap-3 px-4 py-3 bg-[#f4f6f9] border-b border-[#d5dce6]">
                <span className="text-[11px] font-bold bg-[#0d1b2a] text-white px-2 py-0.5 rounded">{ep.method}</span>
                <code className="text-[13px] font-mono text-[#0d1b2a]">{ep.path}</code>
              </div>
              <div className="px-4 py-3">
                <p className="text-[13px] text-[#64748b] mb-3">{ep.description}</p>
                <div className="text-[11px] text-[#64748b] uppercase tracking-wider mb-1">Example curl</div>
                ...
                <div className="text-[11px] text-[#64748b] uppercase tracking-wider mt-3 mb-1">Response</div>
                <pre className="bg-[#f4f6f9] text-[12px] p-3 rounded overflow-x-auto text-[#0d1b2a]">
        ...
        <div className="mt-10 pt-6 border-t border-[#d5dce6]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-[13px] text-[#64748b]">
