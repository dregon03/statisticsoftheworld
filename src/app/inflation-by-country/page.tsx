...
export const metadata: Metadata = {
  ...
  description: 'Inflation rate by country in 2026: all 218 countries ranked by consumer price inflation. From deflation to hyperinflation. Source: IMF World Economic Outlook.',
