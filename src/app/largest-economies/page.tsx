...
export default async function LargestEconomiesPage() {
  ...
  const jsonLd = { '@context': 'https://schema.org', '@graph': [
    ...
    { '@type': 'FAQPage', mainEntity: [
      ...
      { '@type': 'Question', name: 'Is India the fourth-largest economy in 2026?', acceptedAnswer: { '@type': 'Answer', text: 'No. According to the IMF\'s April 2026 World Economic Outlook — the most authoritative source — India ranks sixth, not fourth. The correct top-6 order is: 1. United States ($32.4T), 2. China ($20.9T), 3. Germany ($5.4T), 4. Japan ($4.4T), 5. United Kingdom ($4.26T), 6. India ($4.15T). Some websites and media reports show India as fourth because they use older or alternative data vintage (pre-revision estimates placed India higher), or because they use PPP rankings (where India is indeed third). The April 2026 WEO reflected two factors that reduced India\'s nominal dollar GDP below Japan and the UK: (1) rupee depreciation from 84.6 to 88.5 per US dollar, and (2) India\'s Ministry of Statistics (MoSPI) revised the GDP base year in February 2026, reducing headline nominal GDP by roughly 4%. India remains the fastest-growing major economy at 6.5% and is projected to become the third-largest by the early 2030s. Source: IMF April 2026 WEO.' } },
    ]},
  ]};
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="max-w-[1000px] mx-auto px-6 py-10">
        ...
        <h1 className="text-[32px] font-bold text-[#0d1b2a] mb-2">Top 50 Largest Economies in the World {year}</h1>
